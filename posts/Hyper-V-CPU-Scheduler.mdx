...
![ Child and Parent Partition Hyper-V ](/img/cpuscheduler/Partitions.png)
...
![Simultaneous multithreading SMT Hyper Threading Hyper-V ](/img/cpuscheduler/hyperthreading.png)
...
![ Cinebench SMT Hyper-V ](/img/cpuscheduler/host-score.png)
...
![ Hyper-V Starting Cinebench ](/img/cpuscheduler/run-shot.png)
...
![ Parked CPU ](/img/cpuscheduler/cpu-park.png)
...
![ CPU Wait Time ](/img/cpuscheduler/cpu-wait.png)
...
![ CPU Bios ](/img/cpuscheduler/CPU-bios.png)
...
![ Classic Core SMT CineBench ](/img/cpuscheduler/CPUPerfAverage.png)
...
![ Classic Core SMT CineBench ](/img/cpuscheduler/CPUPerfCumulative.png)
...
~~~~~
![WinEvent](/img/cpuscheduler/change-scheduler.png)
...
~~~~~~
![filtered event](/img/cpuscheduler/core-change.png)
