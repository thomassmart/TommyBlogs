...
![developer program screenshot](/img/100daysofazure/NewDevTenantStep1.png)

2. Sign in with your MSA account. 
3. Fill in your name, a company and other requirements

![developer program screenshot](/img/100daysofazure/NewDevTenantStep2.png)
...
![developer program screenshot](/img/100daysofazure/NewDevTenantStep3.png)
...
![developer program screenshot](/img/100daysofazure/NewDevTenantStep4.png)
...
![developer program screenshot](/img/100daysofazure/NewDevTenantStep5.png)

2. Head over to subscriptions. This pane will be empty. Let's fix it!

![developer program screenshot](/img/100daysofazure/NewDevTenantStep6.png)
...
![developer program screenshot](/img/100daysofazure/NewDevTenantStep7.png)
